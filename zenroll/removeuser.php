...
require 'navbar.php';
$adm = $_POST['adm'];
$sql = "DELETE FROM student WHERE adm = '".$adm."'";
    ...
    <div class="container" style="min-height: 100%">
        <div class="row">
            <div class="text-center"><br>
                ...
                $sql2 = "SELECT * FROM student WHERE adm ='" . $adm . "'";
                $result2 = mysqli_query($conn, $sql2);
                $row2 = mysqli_fetch_array($result2);

                if($row2['adm']=="") {
                    echo '<h3 class="text-muted">Account removed successfully</h3><h2>';
                }
                else
                {
                    echo 'Removal failed';
