...
<div id="mySidenav" class="sidenav"  style="background-color: rgba(50,50,50,1)">
    ...
    <a href="../dashboard.php">Curl Home</a>
    <a href="../librarian/search.php">Issue books</a>
    <a href="../librarian/searchuser.php">Renew books</a>
    <a href="../librarian/searchuser.php">Return books</a>
</div>
